...
import { guessFileExtension, findImageMagickCommand, findLibreOfficeCommand, convertOfficeDocument, convertImageToPdf, convertToPdf, } from "./convertToPdf";
describe("test guessFileExtension", () => {
    it("detects PDF", async () => {
        mockFd.read.mockImplementation((buffer) => {
...
describe("test convertOfficeDocument", () => {
    ...
    it("conversion fails (command not found)", async () => {
        ...
        await expect(convertOfficeDocument("test_command.docx", "./")).rejects.toThrow("LibreOffice is not installed. Please install LibreOffice to convert office documents. On macOS: brew install --cask libreoffice, On Ubuntu: apt-get install libreoffice");
    });
    it("conversion fails (output not found)", async () => {
        ...
        mockProc.stdout.emit("data", "conversion successfull");
        await expect(convertOfficeDocument("test_fail.docx", "./")).rejects.toThrow("LibreOffice conversion succeeded but output PDF not found");
    });
});
describe("test convertImageToPdf", () => {
    ...
    it("conversion fails (command not found)", async () => {
        ...
        mockProc.stdout.emit("data", "command not found");
        await expect(convertImageToPdf("test_command.png", "./")).rejects.toThrow("ImageMagick is not installed. Please install ImageMagick to convert images. On macOS: brew install imagemagick, On Ubuntu: apt-get install imagemagick");
    });
});
...
//# sourceMappingURL=convertToPdf.test.js.map